...
namespace ExploreBookings.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HotelId,ManagerEmail,HotelName,street_number,route,locality,administrative_area_level_1,country,postal_code,Latitude,Longitude,NoOfFloors,TotalNumberOfRooms,HotelDescription,HotelPic,Address")] Hotel hotel, HttpPostedFileBase photoUpload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HotelId,ManagerEmail,HotelName,street_number,route,locality,administrative_area_level_1,country,postal_code,Latitude,Longitude,NoOfFloors,TotalNumberOfRooms,HotelDescription,HotelPic,Address")] Hotel hotel)
        {
            if (ModelState.IsValid)
            {
